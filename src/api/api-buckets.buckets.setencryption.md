...
[Home](./index.md) &gt; [@baboonjs/api-buckets](./api-buckets.md) &gt; [Buckets](./api-buckets.buckets.md) &gt; [setEncryption](./api-buckets.buckets.setencryption.md)
...
|  options | [SetEncryptionOptions](./api-buckets.setencryptionoptions.md) |  |
